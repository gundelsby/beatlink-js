	...
	describe('fromBuffer', function () {
		...
		it('should set broadcast count from packet data', function () {
			...
			const { broadcastCount: actual } =
				DeviceNumberClaimFirst.fromBuffer(buffer);
