...
describe('net/status-tracking/packets/BasePacket', function () {
	...
	describe('toBuffer', function () {
		const packet = new BasePacket(packetTypes.PLAYER_STATUS, 'device name');
...
function runToBufferAssertions(packet) {
	...
	it.skip('should have total packet length as a 16 bit integer at bytes 0x22, 0x23', function () {
		const buffer = packet.toBuffer();
